  ...
  return (
    <section className="about" ref={aboutRef}>
      ...
      <p className="about__text">
        ...
        South London. I use React, Next JS, TypeScript, MongoDB, and MySQL to
        build full stack apps and solve complex problems. I have worked
        professionally in the tech industry for 3 years, as a Full Stack
        Developer at the Science Museum, and in the Royal Academy of Arts'
        Digital Product and Infrastructure team.
        <br />
        <br />
